              ...
              {[
                ...
                >
                  <div className="add" onClick={() => handleToggle(section)}>
                    <div className="text-add self-stretch text-[#002740] text-[28px] font-bold font-space-grotesk leading-9">
      ...
      <section className="container mx-auto">
        <Row>
          ...
          >
            ...
            <div className="self-stretch  flex-col justify-start items-start gap-4 flex">
              <div className="add">
                <div className=" add self-stretch text-[#002740] text-[28px] font-bold font-space-grotesk leading-9">
                  Chi nhánh 2
                </div>
              </div>
              <div className="self-stretch  flex-col justify-start items-start gap-2 flex">
          ...
          >
            <div className="self-stretch flex-col justify-start items-start gap-4 flex">
              <span className="self-stretch text-[#002740] text-[28px] font-bold font-space-grotesk leading-9">
                Đăng Ký Tư Vấn Ngay Để Nhận Giải Pháp Pháp Lý Tốt Nhất!
              </span>
              <div className="self-stretch text-[#606670] text-justify text-base font-normal font-open-sans leading-7">
